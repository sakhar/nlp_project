...
if diff_sets:
    ...
    #X, y_train = build_set('godfather')
    #X, y_train = build_set('inception')
    X, y_train = build_set('shawshank')
    #X_1,y_test = build_set('inception')
    #X_1,y_test = build_set('inception')
    X_1,y_test = build_set('godfather')
    #X_1,y_test = build_set('shawshank')

else:
    X,y = build_set('godfather')
    print Counter(y)
    X,y = build_set('inception')
    print Counter(y)
    X,y = build_set('shawshank')
    print Counter(y)
#print 'shawshank', 'inception'
#print 'inception', 'shawshank'
#X.extend(X_1)
#y.extend(y_1)
...
if diff_sets:
    X_train = dictVec.fit_transform(X)
    X_test = dictVec.transform(X_1)
else:
